...
export default function OneOnOnePrep({ person, onClose }) {
  ...
  }, [person?.id, generateTalkingPoints])
        ...
        {dataSummary && (
          ...
          >
            {[
              ...
              {
                label: 'Blocked',
                val: dataSummary.blocked,
                color: dataSummary.blocked > 0 ? C.red : C.green,
              },
              {
                label: 'Overdue',
                val: dataSummary.overdue,
                color: dataSummary.overdue > 0 ? C.red : C.green,
              },
