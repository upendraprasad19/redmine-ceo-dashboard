  ...
  if (loading) {
    return (
      <div style={{
        ...
        <div style={{ fontSize: 10, letterSpacing: "0.12em", color: C.dimmer, textTransform: "uppercase", fontWeight: 600, marginBottom: 12 }}>
          Escalation Chain
        </div>
        ...
        {escalations.slice(0, 5).map((esc, i) => {
          ...
          return (
            ...
            >
              ...
              {/* Arrow */}
              <svg width="16" height="16" fill="none" stroke={statusColor} strokeWidth="2" viewBox="0 0 24 24" style={{ flexShrink: 0 }}>
              ...
              {/* Reason */}
              <div style={{
                flex: 1, fontSize: 11, color: C.dim,
              ...
              <div style={{
                ...
                <span style={{ fontSize: 10, color: statusColor, fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.04em" }}>
                  {statusLabel}
                </span>
              </div>

              {/* Time */}
              <div style={{ fontSize: 10, color: C.dimmer, flexShrink: 0, minWidth: 48, textAlign: "right" }}>
