...
export default async function handler(req, res) {
  ...
  try {
    ...
    const roleContext = user.role === 'manager'
...
Today is ${new Date().toISOString().split('T')[0]}.`;
    ...
    aiResponse = reply.content || 'I received your message but could not generate a response. Please try rephrasing your question.';
