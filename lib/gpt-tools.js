...
const tools = [
      ...
      parameters: {
        ...
        properties: {
          ...
          created_since: {
            type: 'string',
            description:
              'Return tickets created since this date. Use ISO date (YYYY-MM-DD) or relative values: "this_week", "this_month", "this_quarter"',
          },
          keyword: {
            type: 'string',
          ...
          my_tickets: {
            type: 'boolean',
            description:
              'If true, return only tickets assigned to the current user (uses their linked Redmine account)',
          },
          unassigned: {
            type: 'boolean',
          ...
          reporter_name: {
            type: 'string',
            description:
              'Filter tickets by the person who created/reported them (partial name match)',
          },
        },
      },
    },
  },
  {
    ...
    function: {
      name: 'get_time_logs',
      description:
        'Get time logging data for a period. Shows who logged hours, total hours, and optionally who is missing time entries.',
      parameters: {
        type: 'object',
        properties: {
          range: {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Get a comprehensive summary of a person including their open tickets, hours logged, current workload, leave status, and performance score.',
      parameters: {
        type: 'object',
        properties: {
          person_name: {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Get the status of a project including deadline, completion percentage, risk level, open tickets, and blockers.',
      parameters: {
        type: 'object',
        properties: {
          project_name: {
            type: 'string',
            description:
              'Project name to look up (partial match supported). Omit to get all active projects.',
          },
        },
      },
    },
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Get workload and capacity information for team members. Shows who is overloaded and who has bandwidth.',
      parameters: {
        type: 'object',
        properties: {
          team: {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Search the knowledge base for project documentation, Q&A, and past decisions using semantic search.',
      parameters: {
        type: 'object',
        properties: {
          query: {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Create a new conceptual project exploration (idea / initiative). This is for brainstorming and tracking new ideas.',
      parameters: {
        type: 'object',
        properties: {
          name: {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Generate structured 1-on-1 meeting talking points for a specific person based on their current data (tickets, hours, blockers, performance).',
      parameters: {
        type: 'object',
        properties: {
          person_name: {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Predict whether a project is likely to miss its deadline based on current ticket velocity and remaining work.',
      parameters: {
        type: 'object',
        properties: {
          project_name: {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Get trend data over time: ticket velocity (closed per week), time log compliance trend, overdue ticket trend, creation vs closure rate. Use for questions like "are we improving?", "trend this month", "velocity last 4 weeks".',
      parameters: {
        type: 'object',
        properties: {
          metric: {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Call this when you cannot answer the user\'s question because you lack the data, tool, or capability. This logs the demand for admin review and lets you suggest alternatives. ALWAYS call this instead of just saying "I don\'t know".',
      parameters: {
        type: 'object',
        properties: {
          original_query: {
          ...
          reason: {
            type: 'string',
            description:
              'Why you cannot answer (e.g., "no tool to filter by X", "data not available")',
          },
  ...
  },
  {
    ...
    function: {
      name: 'set_reminder',
      description:
        'Set a reminder for the user. They will receive a Telegram message at the specified time.',
      parameters: {
        type: 'object',
        properties: {
          message: {
          ...
          remind_at: {
            type: 'string',
            description:
              'When to send the reminder. Use natural language: "tomorrow 10am", "in 2 hours", "Friday 3pm", or ISO datetime.',
          },
        },
